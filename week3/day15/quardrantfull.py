...
if QDRANT_URL and QDRANT_API_KEY:
    try:
        ...
        test_client = QdrantClient(url=QDRANT_URL, api_key=QDRANT_API_KEY, check_compatibility=False)
        test_client.get_collections()
        client = test_client
        print("Connected to Qdrant Cloud!")
    except Exception as e:
        print(f"Notice: Qdrant Cloud connection failed ({e}), falling back to in-memory mode...")
